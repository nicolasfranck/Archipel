	...
	if(this.controls){
		...
		*/
		...
		var navbuttons = new Element('div', {
			id: 'navbuttons',
			width: '100px',
			html: '<img id="zoomIn" src="'+this.rooturl+'/images/iip/zoomIn.png" title="zoom in"/><img id="zoomOut" title="zoom out" src="'+this.rooturl+'/images/iip/zoomOut.png"/><img id="reset" title="reset" src="'+this.rooturl+'/images/iip/reset.png"/><img title="fullscreen" src="'+this.rooturl+'/images/iip/fullscreen.png" id="fullscreen" />'
		});
